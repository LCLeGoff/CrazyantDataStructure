...
WrappedSimpleModel = UOWrappedSimpleModel(root, group, new=True, n_replica=1000)

p_attach = 0.051
kappa_orientation = 15
c = round(1-2*np.pi*0.15/2., 2)

for kappa_info in [0.1, 1, 2.38, 10, 100]:
...
adjust = {'top': 0.98, 'bottom': 0.02, 'left': 0.02, 'right': 0.98}
