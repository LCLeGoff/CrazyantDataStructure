...
# BaseFood.compute_distance_to_food_next_to_food()
# BaseFood.compute_orientation_next_to_food()
# BaseFood.compute_orientation_to_food()
# BaseFood.compute_distance_to_food_next_to_food_differential()
BaseFood.exp.load(['speed_next_to_food'])
BaseFood.exp.moving_mean('speed_next_to_food', 100)
